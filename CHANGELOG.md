...
[lego](https://github.com/go-acme/lego) has been updated to v5.5.1 See the
lego [CHANGELOG.md](https://github.com/go-acme/lego/blob/v5.5.1/CHANGELOG.md)
...
[#625](https://github.com/vancluever/terraform-provider-acme/pull/625)

## 3.1.0 (September 4, 2026)

LEGO UPDATE:

[lego](https://github.com/go-acme/lego) has been updated to v5.4.1 See the
lego [CHANGELOG.md](https://github.com/go-acme/lego/blob/v5.4.1/CHANGELOG.md)
for more details on additions and changes to DNS providers, and other minor
changes to the library.
...
[lego](https://github.com/go-acme/lego) has been updated to v5.4.0 (from
v4.35.2).
...
[CHANGELOG.md](https://github.com/go-acme/lego/blob/v5.4.0/CHANGELOG.md) for
...
[lego](https://github.com/go-acme/lego) has been updated to v4.35.2 See the
lego [CHANGELOG.md](https://github.com/go-acme/lego/blob/v4.35.2/CHANGELOG.md)
for more details on additions and changes to DNS providers, and other minor
changes to the library.

## 2.48.0 (April 23, 2026)
...
## 2.47.0 (April 16, 2026)

LEGO UPDATE:

[lego](https://github.com/go-acme/lego) has been updated to v4.34.0 See the
lego [CHANGELOG.md](https://github.com/go-acme/lego/blob/v4.34.0/CHANGELOG.md)
for more details on additions and changes to DNS providers, and other minor
changes to the library.
...
[lego](https://github.com/go-acme/lego) has been updated to v4.33.0 See the
lego [CHANGELOG.md](https://github.com/go-acme/lego/blob/v4.33.0/CHANGELOG.md)
for more details on additions and changes to DNS providers, and other minor
changes to the library.
...
[lego](https://github.com/go-acme/lego) has been updated to v4.32.0 See the
lego [CHANGELOG.md](https://github.com/go-acme/lego/blob/v4.32.0/CHANGELOG.md)
for more details on additions and changes to DNS providers, and other minor
changes to the library.

## 2.44.1 (February 12, 2026)
...
* `resource/acme_certificate`: Added the `min_days_dynamic` option to allow the
  ...
  [#564](https://github.com/vancluever/terraform-provider-acme/pull/564)
...
[lego](https://github.com/go-acme/lego) has been updated to v4.31.0 See the
lego [CHANGELOG.md](https://github.com/go-acme/lego/blob/v4.31.0/CHANGELOG.md)
for more details on additions and changes to DNS providers, and other minor
changes to the library.

## 2.40.0 (December 17, 2025)

LEGO UPDATE:

[lego](https://github.com/go-acme/lego) has been updated to v4.30.1 See the
lego [CHANGELOG.md](https://github.com/go-acme/lego/blob/v4.30.1/CHANGELOG.md)
for more details on additions and changes to DNS providers, and other minor
changes to the library.


## 2.39.0 (December 4, 2025)

LEGO UPDATE:

[lego](https://github.com/go-acme/lego) has been updated to v4.29.0 See the
lego [CHANGELOG.md](https://github.com/go-acme/lego/blob/v4.29.0/CHANGELOG.md)
for more details on additions and changes to DNS providers, and other minor
changes to the library.
...
[lego](https://github.com/go-acme/lego) has been updated to v4.28.0 See the
lego [CHANGELOG.md](https://github.com/go-acme/lego/blob/v4.28.0/CHANGELOG.md)
for more details on additions and changes to DNS providers, and other minor
changes to the library.

## 2.37.0 (October 19, 2025)

LEGO UPDATE:

[lego](https://github.com/go-acme/lego) has been updated to v4.27.0 See the
lego [CHANGELOG.md](https://github.com/go-acme/lego/blob/v4.27.0/CHANGELOG.md)
for more details on additions and changes to DNS providers, and other minor
changes to the library.

## 2.36.0 (September 15, 2025)

LEGO UPDATE:

[lego](https://github.com/go-acme/lego) has been updated to v4.26.0 See the
lego [CHANGELOG.md](https://github.com/go-acme/lego/blob/v4.26.0/CHANGELOG.md)
for more details on additions and changes to DNS providers, and other minor
changes to the library.

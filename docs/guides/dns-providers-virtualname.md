...
# Virtualname DNS Challenge Provider

The `virtualname` DNS challenge provider can be used to perform DNS challenges for
the [`acme_certificate`][resource-acme-certificate] resource with
[Virtualname](https://www.virtualname.es/).

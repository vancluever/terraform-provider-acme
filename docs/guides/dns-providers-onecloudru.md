...
# 1cloud.ru DNS Challenge Provider

The `onecloudru` DNS challenge provider can be used to perform DNS challenges for
the [`acme_certificate`][resource-acme-certificate] resource with
[1cloud.ru](https://1cloud.ru/).

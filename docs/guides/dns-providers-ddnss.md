...
# DDnss (DynDNS Service) DNS Challenge Provider

The `ddnss` DNS challenge provider can be used to perform DNS challenges for
the [`acme_certificate`][resource-acme-certificate] resource with
[DDnss (DynDNS Service)](https://ddnss.de/).

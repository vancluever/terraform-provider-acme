...
# Dinahosting DNS Challenge Provider

The `dinahosting` DNS challenge provider can be used to perform DNS challenges for
the [`acme_certificate`][resource-acme-certificate] resource with
[Dinahosting](https://en.dinahosting.com).
